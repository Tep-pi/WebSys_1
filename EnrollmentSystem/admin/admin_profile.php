...
// Fetch admin info
$stmt = $conn->prepare("
    SELECT first_name, last_name, email, profile_image_path, signature_image_path
    FROM users
    WHERE user_id = ?
    LIMIT 1
");
...
$name = ($u['first_name'] ?? 'System') . " " . ($u['last_name'] ?? 'Administrator');
$email = $u['email'] ?? 'admin';
...
<div class="container">
    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col">
                <p><span class="label">Role:</span> Admin</p>
