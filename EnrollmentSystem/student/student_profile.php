...
$uploadsDirAbs = realpath(__DIR__ . "/../") . "/assets/uploads/student/";
$uploadsDirRel = "assets/uploads/student/";
...
$name = ($u['first_name'] ?? 'Student') . " " . ($u['last_name'] ?? 'User');
$email = $u['email'] ?? 'student';
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="upload_pfp" class="btn-link">Upload profile picture</button>
                </form>
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="upload_signature" class="btn-link">Upload signature</button>
                </form>
            </div>
        </div>
    </div>
